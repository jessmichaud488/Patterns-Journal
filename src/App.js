...
store.dispatch(
  addEntry({
    ...
    entry:
      "From the wood, Alice sees a fish in footman’s livery approach the house and knock on the door. A similarly dressed frog answers the door and receives a letter inviting the Duchess to play croquet with the Queen.",
    hoursSlept: 8,
    entryType: "depressed",
...
store.dispatch(
  addEntry({
    ...
    entry:
      "After the disappearance of the Cheshire Cat, the croquet game starts up again and the Duchess takes Alice’s arm. The two start to walk, and Alice becomes uncomfortable that the Duchess holds her so close. Alice thinks that the Duchess is behaving pleasantly because there isn’t any pepper present.",
    hoursSlept: 7,
    entryType: "depressed",
